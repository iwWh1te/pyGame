...
def show_go_screen():
    ...
    draw_text(screen, "Нажимай стрелки, чтобы двигаться", 23,
              WIDTH / 2, HEIGHT / 5)
    draw_text(screen, "Нажимай пробел, чтобы стрелять", 22,
              WIDTH / 2, HEIGHT / 3)
    draw_text(screen, "Нажми любую кнопку, чтобы начать игру", 18, WIDTH / 2, HEIGHT * 3 / 4)
    pygame.display.flip()
    waiting = True
    while waiting:
        clock.tick(FPS)
...
background = pygame.image.load(path.join(img_dir, "backGroun.jpg")).convert()
